 ...
 */
 ...
 [_QWERTY] = LAYOUT(
  ...
  KC_LSFT,  KC_A,   KC_S,    KC_D,    KC_F,    KC_G,                     KC_H,    KC_J,    KC_K,    KC_L, TD(TD_PUNTOS), TD(TD_COMASD),
  KC_LCTL,  KC_Z,   KC_X,    KC_C,    KC_V,    KC_B, TD(TD_LLAVEI), TD(TD_LLAVEC),  KC_N,    KC_M,    TD(TD_MENOR), TD(TD_MAYOR),  TD(TD_SIGNO), TD(TD_PIPA),
                         MT(MOD_LALT,KC_CAPS), KC_LGUI, MO(_LOWER), KC_ENT,   KC_SPC, MO(_RAISE),TD(TD_MAS), KC_RALT
),
/* LOWER
 * ,-----------------------------------------.                    ,-----------------------------------------.
